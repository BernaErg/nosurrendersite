export const content = {
  ...
  proof: {
    ...
    metrics: [
      { value: 180, suffix: "K+", label: "Downloads", emphasis: true, decimals: 0 },
      { value: 24861, suffix: "", label: "KYC-verified users onboarded", emphasis: false, decimals: 0 },
      { value: 94, suffix: " min", label: "Average daily session length", emphasis: true, decimals: 0 },
      { value: 17.56, suffix: " hrs", label: "Average engagement time per user", emphasis: false, decimals: 2 },
      { value: 37, suffix: "%", label: "D30 retention", emphasis: true, decimals: 0 },
      { value: 16.77, suffix: "%", label: "D90 retention", emphasis: false, decimals: 2 },
      { value: 3.2, suffix: "×", label: "K-factor (industry top: under 1)", emphasis: true, decimals: 2 },
      { value: 1.7, suffix: "M+", label: "Hours of gameplay", emphasis: false, decimals: 1 },
      { value: 1.5, suffix: "M+", label: "Messages in social channels", emphasis: true, decimals: 1 },
      { value: 26, suffix: "M+", label: "Ad impressions", emphasis: false, decimals: 0 },
    ],
  },
  markets: {
